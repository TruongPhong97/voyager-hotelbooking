...
@section('content')
    ...
    <section class="eorik-slider-area">
        <div class="eorik-slider owl-carousel owl-theme">
            ...
            @if(isset($slides)) @forelse ($slides as $slide)
                <div class="eorik-slider-item" style="background-image: url({{ $slide->img_url }});">
                    <div class="d-table">
                            ...
                            <div class="container">
                                <div class="eorik-slider-text overflow-hidden one eorik-slider-text-one">
                                    ...
                                    <div class="slider-btn">
                                        <a class="default-btn" href="{{ $slide->link }}">Book To Stay<i class="flaticon-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="white-shape">
            <img src="assets/frontend/img/home-one/slider/white-shape.png" alt="Image">
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="explore-img">
                        <img src="assets/frontend/img/explore-img.png" alt="Image">
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="incredible-area ptb-140 jarallax">
        ...
        <div class="white-shape">
            <img src="assets/frontend/img/shape/white-shape-top.png" alt="Image">
            <img src="assets/frontend/img/shape/white-shape-bottom.png" alt="Image">
        </div>
    </section>
    <!-- End Incredible Area -->
                    ...
                    <div class="col-lg-4">
                        <ul class="tabs">
                            <li class="single-rooms">
                                <img src="assets/frontend/img/rooms/button-img-1.jpg" alt="Image">
                            ...
                            <li class="single-rooms">
                                <img src="assets/frontend/img/rooms/button-img-2.jpg" alt="Image">
                                <div class="room-content">
                                    <h3>Luxury Room</h3>
                            ...
                            <li class="single-rooms">
                                <img src="assets/frontend/img/rooms/button-img-3.jpg" alt="Image">
                                <div class="room-content">
                                    <h3>Best Room</h3>
                            ...
                            <li class="single-rooms">
                                <img src="assets/frontend/img/rooms/button-img-4.jpg" alt="Image">
                                <div class="room-content">
                                    <h3>Classic Room</h3>
                            ...
                            <li class="single-rooms">
                                <img src="assets/frontend/img/rooms/button-img-5.jpg" alt="Image">
                                <div class="room-content">
                                    <h3>Budget Room</h3>
                                    <span>From $95.9/night</span>
                                </div>
            ...
            <div class="testimonials-wrap owl-carousel owl-theme">
                <div class="single-testimonials">
                    ...
                    <div class="testimonials-content">
                        <img src="assets/frontend/img/testimonials/2.jpg" alt="Image">
                        <h4>Ayman Jenis</h4>
                        <span><a href="https://templates.envytheme.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1053555f505c75716365757c69">[email&#160;protected]</a></span>
                    </div>
                </div>
                <div class="single-testimonials">
                    <ul>
                    ...
                    <p>“Awesome yksum dolor sit ametco elit, sed do eiusmod tempor incididunt et md do eiusmoeiusmod tempor inte emamnsecacing eiusmoeiusmod”</p>
                    <div class="testimonials-content">
                        <img src="assets/frontend/img/testimonials/3.jpg" alt="Image">
                        <h4>Ayman Jenis</h4>
                        <span><a href="https://templates.envytheme.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b9fafcf6f9f5dcd8caccdcd5c0">[email&#160;protected]</a></span>
                    </div>
                </div>
                <div class="single-testimonials">
                    <ul>
                    ...
                    <p>“Awesome yksum dolor sit ametco elit, sed do eiusmod tempor incididunt et md do eiusmoeiusmod tempor inte emamnsecacing eiusmoeiusmod”</p>
                    <div class="testimonials-content">
                        <img src="assets/frontend/img/testimonials/1.jpg" alt="Image">
                        <h4>Ayman Jenis</h4>
                        <span><a href="https://templates.envytheme.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="82c1c7cdc2cee7e3f1f7e7eefb">[email&#160;protected]</a></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="single-news">
                        <div class="news-img">
                            <a href="news-details.html">
                                <img src="assets/frontend/img/news/1.jpg" alt="Image">
                            </a>
                            <div class="dates">
                                <span>HOTEL</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-news">
                        <div class="news-img">
                            <a href="news-details.html">
                                <img src="assets/frontend/img/news/2.jpg" alt="Image">
                            </a>
                            <div class="dates">
                                <span>PRICE</span>
                            </div>
