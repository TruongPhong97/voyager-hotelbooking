(function($) {
	...
	$('#datetimepicker-1').datepicker({
		...
		var check_in_startDate = new Date().setDate(e.date.getDate()+1);
		$('#datetimepicker-2').data('datepicker').setStartDate(new Date(check_in_startDate));
		$('#datetimepicker-2').data('datepicker').setDate(new Date(check_in_startDate));
	});
